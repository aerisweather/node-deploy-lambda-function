...
(function () { return __awaiter(_this, void 0, void 0, function () {
    var cli, params, archiveFile, lambda, Version, env;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                fs.copySync(path.join(__dirname, '../node_modules'), path.join(__dirname, '../node_modules.bak'));
                ...
                archiveFile = path.join(__dirname, 'lambda-function.zip');
            ...
            case 1:
                ...
                return [4 /*yield*/, moveDir(path.join(__dirname, '../node_modules.bak'), path.join(__dirname, '../node_modules'))];
            case 2:
                _a.sent();
